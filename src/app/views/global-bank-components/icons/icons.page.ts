...
paths1:string[] =[];
  ...
  primary = '<app-gb-icons name="airplane-outline" size="large"></app-gb-icons>';
  primary2 = '<app-gb-icons ios="heart-outline" md="heart-sharp"></app-gb-icons>';
  custom1 = '<app-gb-icons name="heart" color="error" [level]="500" isCustomIcons="true"></app-gb-icons>';
